...
The long form: how the transpiler is put together, why each piece
is shaped the way it is, what the supported subset looks like, and
how to extend it. For a quick tour and the CLI, start with
[README.md](README.md).
